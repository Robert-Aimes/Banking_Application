package com.mycompany.firstbank;
...
public class Account_1 {
    ...
    //Class Constructors
    Account_1(String cname, String cid){
        customerName = cname;
        customerID = cid;
    }
    ...
    void showMenu(){
        ...
        do{
            ...
            switch(option){
                ...
                case 'E':
                    System.out.println("Enter how many years you would like to accrue interest: ");
                ...
                default: 
                    System.out.println("Error: Invalid selection: Please select 'A', 'B', 'C', 'D', 'E' or 'F'");
                    break;
            }   
